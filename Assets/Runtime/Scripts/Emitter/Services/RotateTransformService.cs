...
namespace TemperaMental.Emitters
{
    public class RotateTransformService : TransformBaseService
    {
        ...
        public override ulong[] DoTransform(ulong[] groups, TransformEmitterFlags activeEmitters, TransformDirectionFlags direction)
        {
            ulong[] transformedGroups = new ulong[groups.Length];
            bool clockwise = direction.HasFlag(TransformDirectionFlags.Right);
